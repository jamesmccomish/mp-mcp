...
export const getDivisionToolDefinition = {
  ...
  description: [
    ...
    '',
    'Good for: "show me the party breakdown for division 2347", "how did Conservatives vote on the latest tax measure?", drilling in from a division surfaced by parliament_member_voting_history.',
    '',
    "Wrong for: a single member's voting record (use parliament_member_voting_history); searching for divisions by topic (use parliament_topic_tracker).",
    '',
    'Inputs: division_id (required; resolve via parliament_member_voting_history or parliament_topic_tracker), assembly (commons|lords, default commons; Lords support v1.1), response_format (concise|detailed; detailed includes per-MP voter lists).',
    '',
